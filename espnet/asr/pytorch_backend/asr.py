...
def train(args):
    ...
    '''
    if args.mtlalpha == 1.0 and args.mtlbeta == 0.0 and args.mtlgramma == 0.0:
        mtl_mode = "transducer"
        logging.info("Pure transducer mode")
    elif args.mtlalpha == 0.0 and args.mtlbeta == 1.0 and args.mtlgramma == 0.0:
        mtl_mode = "ctc"
        logging.info("Pure ctc mode")
    elif args.mtlalpha == 0.0 and args.mtlbeta == 0.0 and args.mtlgramma == 1.0:
        mtl_mode = "att"
